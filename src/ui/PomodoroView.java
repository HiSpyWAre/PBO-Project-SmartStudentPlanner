...
// // judul
// Label title = new Label("🍅 Pomodoro Timer");
// title.setStyle("-fx-font-size: 32px; -fx-font-weight: bold; -fx-text-fill:
// #cdd6f4;");
...
// content.getChildren().addAll(title, timerDisplay, controls, settings,
// sessionInfo, stats);

// ScrollPane scrollPane = new ScrollPane(content);
// scrollPane.setFitToWidth(true);
// scrollPane.setStyle("-fx-background: #2a2a3e; -fx-background-color:
// #2a2a3e;");
// scrollPane.setHbarPolicy(ScrollPane.ScrollBarPolicy.NEVER); // No horizontal
// scroll
// scrollPane.setVbarPolicy(ScrollPane.ScrollBarPolicy.AS_NEEDED); // Vertical
// scroll when needed
...
// startPauseBtn.setPrefSize(150, 50);
// startPauseBtn.setStyle("-fx-background-color: #a6e3a1; -fx-text-fill:
// #1e1e2e; " +
// "-fx-font-size: 18px; -fx-font-weight: bold;");
// startPauseBtn.setOnAction(e -> toggleTimer());
...
// settings.setAlignment(Pos.CENTER);
// settings.setPadding(new Insets(20));
// settings.setStyle("-fx-background-color: #313244; -fx-background-radius:
// 10;");
...
// Label sessionsCount = new Label(String.valueOf(completedSessions));
// sessionsCount.setStyle("-fx-text-fill: #89b4fa; -fx-font-size: 48px;
// -fx-font-weight: bold;");
...
// for (int i = 0; i < 4; i++) {
// Circle dot = new Circle(8);
// dot.setFill(i < completedSessions % 4 ? Color.web("#f38ba8") :
// Color.web("#313244"));
// dots.getChildren().add(dot);
// }

// Label longBreakLabel = new Label("Long break after 4 sessions");
// longBreakLabel.setStyle("-fx-text-fill: #6c7086; -fx-font-size: 11px;
// -fx-font-style: italic;");

// info.getChildren().addAll(sessionsLabel, sessionsCount, dots,
// longBreakLabel);
// return info;
// }
...
// Label valueText = new Label(value);
// valueText.setStyle("-fx-text-fill: " + color + "; -fx-font-size: 32px;
// -fx-font-weight: bold;");
...
// isRunning = true;
// startPauseBtn.setText("Pause");
// startPauseBtn.setStyle("-fx-background-color: #fab387; -fx-text-fill:
// #1e1e2e; " +
// "-fx-font-size: 18px; -fx-font-weight: bold;");
...
// int breakDuration = (completedSessions % 4 == 0) ? 15 * 60 :
// this.breakDuration;

// // Show completion alert
// showCompletionAlert("🎉 Focus Session Complete!",
// "Great work! Time for a " + (breakDuration / 60) + "-minute break.");
...
// // Refresh UI to show updated session count
// VBox mainContent = (VBox) view.getCenter();
// mainContent.getChildren().clear();
// buildView(); // Rebuild to update session dots
...
// // Don't auto-start focus - biar user yang mulai
// startPauseBtn.setText("Start");
// startPauseBtn.setStyle("-fx-background-color: #a6e3a1; -fx-text-fill:
// #1e1e2e; " +
// "-fx-font-size: 18px; -fx-font-weight: bold;");
